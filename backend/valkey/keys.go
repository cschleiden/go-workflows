...
func (k *keys) instancesByCreation() string {
	return fmt.Sprintf("%sinstances-by-creation:{global}", k.prefix)
}
...
func (k *keys) instancesActive() string {
	return fmt.Sprintf("%sinstances-active:{global}", k.prefix)
}

func (k *keys) instancesExpiring() string {
	return fmt.Sprintf("%sinstances-expiring:{global}", k.prefix)
}
...
func (k *keys) futureEventsKey() string {
	return fmt.Sprintf("%sfuture-events:{global}", k.prefix)
}
